...
static void get_number(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index);
static void get_variable(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index);
static void get_definition_of_function(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index);
static void get_staples_expression_or_number_or_variable(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index);
static void get_expression_with_plus_or_minus(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index);
static void get_expression_with_mul_or_div(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index);
static void get_expression_with_pow(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index);
static void get_expression_with_comparison_operations(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index);
...
static void get_operator_else(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index);
...
static void get_definition_of_function(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index)
{
    ...
    ON_DEBUG(getchar();)
    get_function(&left_node, lexical_analyze_array, len_of_lexical_analyze_array, index);
    if (((lexical_analyze_array[*index]).value).type != OPERATOR ||
    ...
    ON_DEBUG(getchar();)
    get_operator(&right_node, lexical_analyze_array, len_of_lexical_analyze_array, index);
    if (((lexical_analyze_array[*index]).value).type != OPERATOR ||
    ...
    ON_DEBUG(getchar();)
    get_operator(&node_after_operator, lexical_analyze_array, len_of_lexical_analyze_array, index);
    Errors_of_tree error = create_new_node(root, &new_node_value, left_node, right_node);
...
static void get_assignment_operator_or_function(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index)
{
        ...
        ((lexical_analyze_array[*index]).value).operator_ == OPERATOR_DEF)
    {
        ...
        ON_DEBUG(getchar();)
        get_definition_of_function(root, lexical_analyze_array, len_of_lexical_analyze_array, index);
        return;
    }
        ...
        ((lexical_analyze_array[*index]).value).type == BUILT_IN_FUNCTION)
    {
        ...
        ON_DEBUG(getchar();)
        get_function(root, lexical_analyze_array, len_of_lexical_analyze_array, index);
        return;
    }
    ON_DEBUG(printf("go to get_assignment_operator from get_assignment_operator_or_function\n");)
    ON_DEBUG(getchar();)
    get_assignment_operator(root, lexical_analyze_array, len_of_lexical_analyze_array, index);
    return;
}
...
static void get_assignment_operator(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index)
{
    ...
    ON_DEBUG(getchar();)
    get_variable(&left_node, lexical_analyze_array, len_of_lexical_analyze_array, index);
    if (left_node == NULL)
    {
        return;
    }
        ...
        ((lexical_analyze_array[*index]).value).type == BUILT_IN_FUNCTION)
    {
        ...
        ON_DEBUG(getchar();)
        get_function(&right_node, lexical_analyze_array, len_of_lexical_analyze_array, index);
    }
    else
    {
        ON_DEBUG(printf("go to get_staples_expression_or_number_or_variable from get_assignment_operator\n");)
        ON_DEBUG(getchar();)
        get_staples_expression_or_number_or_variable(&right_node, lexical_analyze_array, len_of_lexical_analyze_array, index);
    }
...
static void get_if_or_while_operator(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index)
{
    ...
    ON_DEBUG(getchar();)
    get_expression_with_comparison_operations(&left_node, lexical_analyze_array, len_of_lexical_analyze_array, index);
    ...
    ON_DEBUG(getchar();)
    get_operator_else(&node_for_operator_else, lexical_analyze_array, len_of_lexical_analyze_array, index);
...
static void get_operator(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index)
{
         ...
         ((lexical_analyze_array[*index]).value).operator_ == OPERATOR_WHILE))
    {
        ...
        ON_DEBUG(getchar();)
        get_if_or_while_operator(root, lexical_analyze_array, len_of_lexical_analyze_array, index);
        return;
    }
    else
    {
        ...
        ((lexical_analyze_array[*index]).value).operator_ == OPERATOR_RETURN)
        {
            ...
            ON_DEBUG(getchar();)
            get_operator_return(root, lexical_analyze_array, len_of_lexical_analyze_array, index);
            return;
        }
        else
        {
...
static void get_staples_expression_or_number_or_variable(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index)
{
        ...
        ((lexical_analyze_array[*index]).value).operator_ == OPERATOR_ROUND_BRACKET_OPEN)
    {
        ...
        ON_DEBUG(getchar();)
        get_expression_with_plus_or_minus(root, lexical_analyze_array, len_of_lexical_analyze_array, index);
        // if (*buffer[0] != ')')
        // {
        //     syntax_error(buffer, index);
        // }
    ...
    else if (((lexical_analyze_array[*index]).value).type == VARIABLE)
    {
        ...
        ON_DEBUG(getchar();)
        get_variable(root, lexical_analyze_array, len_of_lexical_analyze_array, index);
        return;
    }
    else if (((lexical_analyze_array[*index]).value).type == NUMBER)
    {
        ...
        ON_DEBUG(getchar();)
        get_number(root, lexical_analyze_array, len_of_lexical_analyze_array, index);
...
static void get_expression_with_mul_or_div(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index)
{
    ...
    ON_DEBUG(getchar();)
    get_expression_with_pow(&left_node, lexical_analyze_array,len_of_lexical_analyze_array, index);
           ...
           ((lexical_analyze_array[*index]).value).operation == OP_DIV)
    {
        ...
        ON_DEBUG(printf("go to get_expression_with_pow from get_expression_with_mul_or_div\n");)
        ON_DEBUG(getchar();)
        get_expression_with_pow(&right_node, lexical_analyze_array, len_of_lexical_analyze_array, index);
        Errors_of_tree error = create_new_node(root, &new_node_value, left_node, right_node);
        if (error != NO_ERRORS_TREE)
        {
            fprintf(stderr, "error = %d\n", error);
...
static void get_expression_with_plus_or_minus(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index)
{
    ...
    ON_DEBUG(getchar();)
    get_expression_with_mul_or_div(&left_node, lexical_analyze_array, len_of_lexical_analyze_array, index);
           ...
           ((lexical_analyze_array[*index]).value).operation == OP_SUB)
    {
        ...
        ON_DEBUG(printf("go to get_expression_with_mul_or_div from get_expression_with_plus_or_minus\n");)
        ON_DEBUG(getchar();)
        get_expression_with_mul_or_div(&right_node, lexical_analyze_array, len_of_lexical_analyze_array, index);
        Errors_of_tree error = create_new_node(root, &new_node_value, left_node, right_node);
        if (error != NO_ERRORS_TREE)
        {
            fprintf(stderr, "error = %d\n", error);
...
static void parse_information_from_lexical_analyze_array_by_recursive_descent(struct Node **root, struct Node *lexical_analyze_array, int len_of_lexical_analyze_array, int *index)
{
    ...
    ON_DEBUG(getchar();)
    get_operator(root, lexical_analyze_array, len_of_lexical_analyze_array, index);
    //get_expression_with_plus_or_minus(lexical_analyze_array, buffer, end_pointer, index);
